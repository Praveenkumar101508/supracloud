  ...
  return (
    <footer className="sc-footer">
      <div className="container footer-grid">
        ...
        <div><h5>AI Solutions</h5><ul><li><Link href="/solutions/banking">Banking AI</Link></li><li><Link href="/solutions/supermarket">Supermarket AI</Link></li></ul></div>
        <div><h5>Enterprise</h5><ul><li><Link href="/services/it-staffing">IT Staffing</Link></li><li><Link href="/services/consultation">Consultation</Link></li></ul></div>
        <div><h5>Talent Hub</h5><ul><li><Link href="/careers/internships">Internships</Link></li><li><Link href="/careers/training">Training</Link></li></ul></div>
        <div><h5>Engagement</h5><ul><li><Link href="/book">Book a Demo</Link></li><li><Link href="/portal">Client Portal</Link></li></ul></div>
      </div>
